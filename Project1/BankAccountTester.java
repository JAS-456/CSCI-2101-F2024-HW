...
public class BankAccountTester {
    public static void main(String[] args) {
        ...
        BankAccount.interact(bankMain, bank2Transfer, 200);
         System.out.println("John's balance: " + bankMain.getBalance());
        System.out.println("Bill's balance: " + bank2Transfer.getBalance());
    }
}